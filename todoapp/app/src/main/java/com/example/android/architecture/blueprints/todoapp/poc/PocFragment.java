...
public class PocFragment extends android.support.v4.app.Fragment implements PocContract.View, PocItemListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mToDosList = (ListView) view.findViewById(R.id.toDos_list);
        mPocsView = (RelativeLayout) view.findViewById(R.id.pocsLayout);
        mNoPocs = (LinearLayout) view.findViewById(R.id.noPocsLayout);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_local: {
                mPocPresenter.getPocs(false);
                return true;
            }
            case R.id.menu_remote: {
                mPocPresenter.getPocs(true);
                return true;
